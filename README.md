...
<body>
    <div class="card">
        <div class="image">
            <img width="188" src="boat.jpg" alt="">
        </div>
        ...
        <div class="content">
            <h2>Boat Man</h2>
            <p>The boatman sails through storms with calm and strength, guiding his way with every steady stroke,
                fearless against the tides.</p>
        </div>
        <div class="button">
